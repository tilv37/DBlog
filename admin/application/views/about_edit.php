...
<?php $this->load->view("sidebar") ?>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <?php echo form_open('about/update_page/'.$this->uri->segment(3))?>

        <ul class="list-group">
            <input type="hidden" name="cid" value="<?php echo $page[0]['cid'] ?>"/>
            <li class="list-group-item"><?php echo form_label('标题:');?>
                <?php echo form_error('title'); ?>
                <?php echo form_input(array('name'=>'title','class'=>'form-control','readonly'=>'readonly'),$page[0]['title']);?>
            </li>
            <li class="list-group-item"><?php echo form_label('内容:');?>
                <!-- 加载编辑器的容器 -->
                <?php echo form_error('contents'); ?>
                <script id="container" name="contents" type="text/plain" style="height: 300px"><?php echo $page[0]['content'];?></script>
            </li>
